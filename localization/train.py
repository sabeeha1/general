...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if opt.image_weights:
            # Generate indices
            if rank in [-1, 0]:
                cw = model.class_weights.numpy() * (1 - maps) ** 2  # class weights
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/home/neural/Documents/Sabeeha/PycharmProjects/localization/weights/groc60.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='cfg/p6.cfg', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/grocm/data.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='data/hyp.scratch.1280.yaml', help='hyperparameters path')
    parser.add_argument('--epochs', type=int, default=1)#change to 300 later
